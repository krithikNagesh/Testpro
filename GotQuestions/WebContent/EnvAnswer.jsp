...
<body>
<c:set var="envQNum" value="${env_question_number}" />
 <%-- Hello <c:out value="${env_question_number}"/> --%>
...
SELECT ENV_QUESTION_ID,ENV_NUMBER_QUESTION,ENV_QUESTION,answer from envquestion WHERE ENV_NUMBER_QUESTION = ?
<sql:param value="${env_question_number}" />
</sql:query>
